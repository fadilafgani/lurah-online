...
<html lang="id">
            ...
            <section class="relative min-h-[720px] overflow-hidden">
                ...
                <div class="relative z-10 flex min-h-[720px] items-center justify-center">
                    <div class="mx-auto max-w-3xl px-6 text-center">
                        ...
                        <!-- Desc -->
                        <p class="mx-auto mt-6 max-w-2xl text-Plus Jakarta Sans font-semibold leading-relaxed text-white">
                        ...
                        <div class="mt-10 flex flex-wrap items-center justify-center gap-4">
                            ...
                            <a href="{{ url('/pengaduan')}}"
                                class="inline-flex items-center gap-2 rounded-xl bg-white px-7 py-3 text-sm font-semibold text-[#153655] transition font-size">
                                Buat Pengaduan 
                                <svg
    ...
    <div class="relative rounded-3xl border border-slate-200 bg-white p-8 shadow-lg transition hover:-translate-y-1 hover:shadow-xl">
        ...
        <!-- <header class="w-full text-sm mb-6 not-has-[nav]:hidden">
            <nav class="flex items-center justify-between px-5 py-4 bg-white border-b border-gray-200 shadow-sm">
    
                {{-- Logo --}}
                <a href="/" class="flex items-center gap-2 font-extrabold text-blue-800 text-lg" style="font-family: 'Plus Jakarta Sans', sans-serif; font-weight: 800; background: linear-gradient(to right, #0047AB, #001D45); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">
                    <img src="{{ asset('images/logo.svg') }}" alt="Logo" class="w-8 h-8 ">
                    LurahOnline
                </a>

                {{-- Menu Tengah --}}
                <ul  class="flex items-center text-sm font-semibold text-gray-700 gap-4">
                    <li><a href="/beranda" class="hover:text-blue-600" style="font-family: 'Plus Jakarta Sans', sans-serif; font-weight: 600; color: #464646;">Beranda</a></li>
                    <li><a href="/pengaduan" class="hover:text-blue-600" style="font-family: 'Plus Jakarta Sans', sans-serif; font-weight: 600; color: #464646;">Buat Pengaduan</a></li>
                    <li><a href="/lacak" class="hover:text-blue-600" style="font-family: 'Plus Jakarta Sans', sans-serif; font-weight: 600; color: #464646;">Lacak Tiket</a></li>
                    <li><a href="/laporan" class="hover:text-blue-600" style="font-family: 'Plus Jakarta Sans', sans-serif; font-weight: 600; color: #464646;">Laporan Publik</a></li>
                </ul>

                {{-- Tombol Admin --}}
                <a href="/admin" class="border border-gray-400 text-gray-700 px-4 py-1 rounded-md text-sm hover:bg-gray-100">
                    Admin
                </a>
